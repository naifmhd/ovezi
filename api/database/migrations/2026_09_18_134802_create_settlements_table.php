...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('settlements', function (Blueprint $table) {
            ...
            $table->foreignId('from_placeholder_id')->nullable()->constrained('placeholders')->restrictOnDelete();
            $table->foreignId('to_user_id')->nullable()->constrained('users')->restrictOnDelete();
            $table->foreignId('to_placeholder_id')->nullable()->constrained('placeholders')->restrictOnDelete();
